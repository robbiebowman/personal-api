...
dependencies {
	// Spring
	implementation("org.springframework.boot:3.2.6")
	...
	implementation("com.github.robbiebowman:mini-crossword-maker:1.0.5")
	...
	// Test
	testImplementation("org.springframework.boot:3.2.6")
}
